...
def render_promo(
    ...
    if caminho_foto:
        ...
        # Nudge vertical relativo ("suba/desça a foto") aplicado por cima.
        delta_focus = render_overrides.get("photo_focus_delta_y")
        if delta_focus is not None:
            focus_y_efetivo = focus_y_efetivo + float(delta_focus)
